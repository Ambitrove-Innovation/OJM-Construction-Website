    ...
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="grid lg:grid-cols-2 gap-16 mb-24">
          <motion.div
            ...
            <p className="text-xl text-black/60 mb-12">
              ...
              ready to provide you with a professional quote and expert advice.
            </p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-full h-125 rounded-[40px] overflow-hidden glass p-4">
          <iframe
            ...
            title="OJM Project Construction Location"></iframe>
        </motion.div>
      </div>
    </div>
  );
