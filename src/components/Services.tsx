    ...
    <section id="services" className="max-w-7xl mx-auto px-6 py-24">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
        ...
        <p className="text-black/70 max-w-md text-lg">
          We provide end-to-end construction solutions with a focus on quality,
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {SERVICES.map((service, index) => (
          <motion.div
            ...
            className="group relative h-125 rounded-[40px] overflow-hidden shadow-xl">
            {/* Background Image */}
            <img
              src={service.image}
      ...
      <motion.div
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="relative h-100 rounded-[40px] overflow-hidden shadow-2xl group">
            <img
              src="/images/ojm_interior_renovation.webp"
              alt="OJM Extra Services"
          ...
          <div className="relative h-100 rounded-[40px] overflow-hidden shadow-2xl group">
            <img
              src="/images/ojm_tilling.webp"
              alt="OJM Services List"
              className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
              referrerPolicy="no-referrer"
            />
            <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
